/*!
  ...
  */
var VueI18nBridge = (function (exports, compositionApi) {
  'use strict';
  ...
  function createComposer(options = {}, VueI18nLegacy) {
      ...
      // prettier-ignore
      const _datetimeFormats = compositionApi.ref(isPlainObject(options.datetimeFormats)
              ? options.datetimeFormats
              : { [_locale.value]: {} })
          ;
      // prettier-ignore
      const _numberFormats = compositionApi.ref(isPlainObject(options.numberFormats)
              ? options.numberFormats
              : { [_locale.value]: {} })
          ;
  ...
  function useI18nForLegacy(instance, scope, root, options = {} // eslint-disable-line @typescript-eslint/no-explicit-any
      ...
      const _composer = compositionApi.shallowRef(null);
      ...
      // messages
      const messages = compositionApi.computed(() => {
          if (_composer.value) {
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      const datetimeFormats = compositionApi.computed(() => _datetimeFormats.value);
      const numberFormats = compositionApi.computed(() => _numberFormats.value);
      function getPostTranslationHandler() {
          return _composer.value
